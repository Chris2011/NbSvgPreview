...
@MultiViewElement.Registration(
        ...
        preferredID = "Preview",
        position = 100)
public class NbSvgPreviewMVPreviewElement implements MultiViewElement, FileChangeListener {
    private FileObject obj;
    private JToolBar tb = new JToolBar();
    private static JFXPanel fxContainer;
    private HTMLEditor htmlEditor;
    
    public NbSvgPreviewMVPreviewElement(Lookup lkp) {
    ...
    private void createScene() {
        ...
        try {
            ...
            Logger.getLogger(NbSvgPreviewMVPreviewElement.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void setMultiViewCallback(MultiViewElementCallback mvec) {
        mvec.getTopComponent().setDisplayName(obj.getNameExt());
    }
